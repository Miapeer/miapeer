...
<MiapeerPage pageTitle="Miapeer: Portfolio" headline="Jeffery Navarra" {data}>
    <div class="portfolio">
        ...
        <section class="personal">
            ...
            <div class="summary">
                I'm a software engineer with over 25 years of experience. Most of my experience has
                ...
                development. I'm always looking to learn new skills to add to my toolbelt.
            </div>
        </section>
        ...
        <section class="experience-list">
                ...
                <div class="details">
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    My day-to-day work involved the debugging and the creation of
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I had the opportunity to work with the same key personnel on
                                ...
                                <li>
                                    This feature was foundational for the key engineering goals to
                                    ...
                                    integration component with ProcessUnity.
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                ...
                                <li>
                                    ...
                                    personal finances to this day.
                                </li>
                                <li>
                                    This is hosted on Microsoft Azure utilizing continuous
                                    deployment via Azure DevOps and Azure Container Registry.
                                </li>
                                <!-- <li>
                ...
                <div class="details">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    ...
                                    orders, website routing, and more.
                                </li>
                                <li>
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I worked with the marketing department to create a more
                                    ...
                                    import of marketing contact lists.
                                </li>
                                <li>
                                    The updated process performed data validation and normalization
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I improved the user's search experience by incorporating
                                    Google's Geolocation service to allow for more casual address
                                    input.
                                </li>
                                <li>
                                    I updated the email marketing opt-out form to use React. This
            ...
            <div class="experience">
                ...
                <div class="details">
                    <div class="detail">
                        <h4 class="h4 task">
                            Department of Energy EPHA (Emergency Planning Hazards Assessment)
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                ...
                                <li>
                                    I pioneered and implemented an approximation algorithm for
                                    chemical Threshold Screening Quantity calculation to improve
                                    accuracy and reduce unnecessary analysis.
                                </li>
                                <li>
                    ...
                    <div class="detail">
                        <h4 class="h4 task">
                            Lead developer of CAPARS (Computer Assisted Protective Action
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                ...
                                <li>
                                    I created the next generation version for EPHA generation using
                                ...
                                <li>
                                    ...
                                    including OS upgrades, repairs, and security updates.
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    This was originally developed as a desktop application for
                                ...
                                <li>
                                    It originally handled chemical and radiological hazard scenarios
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I set up and administered an on-premises installation of Jira
                                    for issue management and process workflow adherence.
                                </li>
                                <li>
                                    I worked on a company IEEE-compliance committee for Software
                                ...
                                <li>
                                    I managed the evolution of our source code and company
                                    documentation from CVS to Subversion and then later split them
                                    to more modern specialty tools, Git and Sharepoint
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I became the primary individual responsible for any IT issues
                                    that came up. I built, purchased, and maintained workstations
                                    and servers, upgraded the network infrastructure, and
                                    implemented security protocols.
                                </li>
                                <li>
                                    When the company shifted to a fully remote workforce, I played a
                                    ...
                                    other collaborative tools such as Slack.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="details">
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I developed a database application designed to track the
                                    treatment plans for offender rehabilitation.
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    ...
                                    they need for optimal software utilization.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="details">
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I provided basic customer support over the phone and escalated
                                    as necessary.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    ...
                                    and operational status of their subscriptions.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="details">
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    As a billing associate, I was shocked at how long it took to
                                    ...
                                    individuals for their "sign off".
                                </li>
                                <li>
                                    I was able to reduce the refund processing time from 4-6 weeks
                                    to 4-5 days.
                                </li>
                                <li>
                                    Through this effort, I landed a role as a Reporting Analyst and
                                    also received recognition as employee of the month.
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    My focus in this role was on dynamic data import and export,
                                    report generation, and process automation.
                                </li>
                                <li>
                                    I developed and maintained dozens of Access Database
                                ...
                                <li>
                                    Due to the large number of databases that I worked with daily, I
                    ...
                    <div class="detail">
                        ...
                        <div class="notes">
                            <ul class="list-disc">
                                <li>
                                    I provided both scheduled and ad hoc reporting support for all
                                    three call center management teams.
                                </li>
                            </ul>
                        </div>
                    </div>
