<script lang="ts">
    ...
    let selectedAmount = (data.transaction.amount / 100).toLocaleString(navigator.language, {
    ...
    const handleEditTransaction = async () => {
        ...
        const res = await fetch(
            `/quantum/accounts/${data.transaction.account_id}/transactions/${data.transaction.transaction_id}`,
            {
                method: 'POST',
