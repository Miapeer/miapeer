...
export async function load({ fetch, parent }) {
    ...
    const headers = {
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJqZXBuMTNAZ21haWwuY29tIiwiZXhwIjoxNjczMjM2ODM5fQ.oWjX4RDbKDkWRrjAZlPM6aL5abXalfBucwUPT7PyTEg',
    }
